...
//    const animals =  [ {animal:'cat', owner:'buchi'},
//    {animal:'dog', owner:'messo'},  {animal:'bird', owner:'ozy'} ] ;

//    const [animalOne, animalTwo, animalThree] = animals;

//    const{animal, owner} = animalOne;
